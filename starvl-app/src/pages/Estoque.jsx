...
// ── Estoque de Combustíveis — design de cards com barras de nível ─────────────
          ...
          {dados.map(comb => {
            ...
            return (
              <div key={comb.produtoCodigo} className="comb-card">
                ...
                {/* ── Total consolidado (múltiplos tanques) ── */}
